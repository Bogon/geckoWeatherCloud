...
final class DailyJobInfoViewModel {
    ...
    init(input: (
         ...
         networkService: DailyJobNetworkService)) {
...
class DailyJobNetworkService {
    ...
    func hotJobInfo() -> Driver<[HotJobListSection]> {
        page = 1
        let params: [String: Any] = ["recType": 1,
                                     "catename": "jianzhi",
                                     "pagesize": 15,
                                     "localname": "sh",
                                     "format": "json",
