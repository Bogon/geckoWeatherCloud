...
- (void)startAnimationIsAll:(BOOL)isAll
    ...
    if ([self isKindOfClass:[UICollectionView class]]) {
        ...
        if (tableView.delegate) {
            tabAnimated.originDelegate = tableView.delegate;
        }
        
        if (tableView.dataSource) {
            tabAnimated.originDataSource = tableView.dataSource;
        }
        
        tableView.delegate = tabAnimated;
        tableView.dataSource = tabAnimated;
...
- (void)tab_endAnimationIsEaseOut:(BOOL)isEaseOut {
    ...
    if ([self isKindOfClass:[UITableView class]]) {
        ...
        tableView.delegate = tabAnimated.originDelegate;
        tableView.dataSource = tabAnimated.originDataSource;
